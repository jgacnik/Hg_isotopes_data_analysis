...
# Project-relative paths and input filename
path_data <- "data"
path_figures <- "figures"
path_tables <- "tables"
data_filename <- "Literature data all.xlsx" # Hg isotope data available in the Supplement
...
data <- read_excel(file.path(path_data, data_filename), skip = 1) %>%
...
ggplot(data = data_meta) +
  ...
  theme(axis.text.x = element_text(size = 9, colour = "black", angle = 45, hjust = 1.2, vjust = 1.07),
        ...
        legend.position = "top")
ggsave(filename = "Figure_1.png", path = path_figures, device = "png", width = 90, height = 70, units = "mm", dpi = 600)
...
ggplot(data = data_emission) +
  ...
  theme(axis.text.x = element_text(size = 7, colour = "black"),
        ...
        legend.position = "top")
ggsave(filename = "Figure_2a.png", path = path_figures, device = "png", width = 90, height = 80, units = "mm", dpi = 600)
...
ggplot(data = data_emission_2) +
  ...
  theme(axis.text.x = element_text(size = 7, colour = "black"),
        ...
        legend.margin = margin(b = -0.3, unit = "cm"),
        legend.position = "top")
ggsave(filename = "Figure_2b.png", path = path_figures, device = "png", width = 90, height = 80, units = "mm", dpi = 600)
...
ggsave(filename = "Figure_3a.png", path = path_figures, device = "png", width = 75, height = 90, units = "mm", dpi = 600)
...
ggsave(filename = "Figure_3b.png", path = path_figures, device = "png", width = 95, height = 90, units = "mm", dpi = 600)
...
write.csv(median_ambient, file = file.path(path_tables, "TGMGEM vs RM table.csv"))
...
ggplot(data = data_ambient_tgm) +
  ...
  theme(axis.text.x = element_text(size = 7, colour = "black"),
        ...
        strip.text = element_text(size = 6.5, colour = "black"),
        legend.position = "none")
ggsave(filename = "Figure_4a.png", path = path_figures, device = "png", width = 90, height = 90, units = "mm", dpi = 600)
...
ggplot(data = boxplot_data, aes(x = Value, y = Type, colour = Type)) +
  ...
  theme(axis.text.x = element_text(size = 8, colour = "black"),
        ...
        strip.text = element_text(size = 8, colour = "black"),
        legend.position = "none")
ggsave(filename = "Figure_4b.png", path = path_figures, device = "png", width = 90, height = 90, units = "mm", dpi = 600)
...
# Tests for D199
anova_D199Hg <- aov(D199Hg ~ Type, data = data_ambient_tgm)
...
ggplot(data = data_ambient_tgm) +
  ...
  theme(axis.text.x = element_text(size = 7, colour = "black"),
        ...
        panel.grid.minor = element_blank(),
        legend.position = "none")
ggsave(filename = "Figure_5a.png", path = path_figures, device = "png", width = 90, height = 110, units = "mm", dpi = 600)
...
ggplot(data = data_ambient_tgm_noMB) + 
  ...
  theme(axis.text.x = element_text(size = 7, colour = "black"),
        ...
        panel.grid.minor = element_blank(),
        legend.position = "none")
ggsave(filename = "Figure_5b.png", path = path_figures, device = "png", width = 90, height = 77, units = "mm", dpi = 600)
...
ggsave(filename = "Figure_6.png", path = path_figures, device = "png", width = 90, height = 70, units = "mm", dpi = 600)
...
write.csv(data_unique, file = file.path(path_tables, "data_unique.csv"), row.names = FALSE)
...
write.csv(median_all, file = file.path(path_tables, "Pass vs act table.csv"))
...
write.csv(data_method, file = file.path(path_tables, "Gold vs carbon table.csv"))
